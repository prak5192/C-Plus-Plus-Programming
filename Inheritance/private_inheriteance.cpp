...
class Pri: private Base
{
    ...
    Pri()
    {
        // The derived class always uses the immediate parent's 
        // class access specifications
        // Thus, Pub uses Base's access specifiers
        m_nPublic = 1; // okay: anybody can access public members
        //  m_nPrivate = 2; // not okay: derived classes can't access 
                          // private members in the base class!
        m_nProtected = 3; // okay: derived classes can access 
                          // protected members
    }
};
...
int main()
{
    ...
    Pri cPri;
 //   cPri.m_nPublic = 1; // not okay: m_nPublic is now a 
                          // private member when accessed through Pri
 //   cPri.m_nPrivate = 2; // not okay: can not access private 
                           // members from outside class
 //   cPri.m_nProtected = 3; // not okay: m_nProtected is now 
                             // a private member when accessed through Pri
